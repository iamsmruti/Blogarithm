             ...
             <Container>
                <Grid sx={{pl: 3, pr: 3, pb: 3}} container spacing={3}>
                    ...
                    <Typography variant="h6" sx={{color: 'white', mt: 2}}>Categories</Typography>
                        <Link href={'/blog/news'}>
                            <a>
                            <Typography variant="body1" sx={{color: 'gray', "&:hover": {color: deepPurple[400]}, mt: 2}}>News</Typography>
                            </a>
                        </Link>
                        <Link href={'/blog/science'}>
                            <a>
                            <Typography variant="body1" sx={{color: 'gray', "&:hover": {color: deepPurple[400]}, mt: 2}}>Science</Typography>
                            </a>
                        </Link>
                        <Link href={'/blog/programming'}>
                            <a>
                            <Typography variant="body1" sx={{color: 'gray', "&:hover": {color: deepPurple[400]}, mt: 2}}>Programming</Typography>
                            </a>
                        </Link>
                        <Link href={'/blog/gadgets'}>
                            <a>
                            <Typography variant="body1" sx={{color: 'gray', "&:hover": {color: deepPurple[400]}, mt: 2}}>Gadgets</Typography>
                            </a>
                        </Link>
                        <Link href={'/blog/tutorials'}>
                            <a>
                            <Typography variant="body1" sx={{color: 'gray', "&:hover": {color: deepPurple[400]}, mt: 2}}>Tutorials</Typography>
                            </a>
                        </Link>
                    </Grid>
